...
contract HAPE is ERC721, ERC721Enumerable, Ownable {

    using SafeMath for uint256;

    string public PROVENANCE;
    uint256 public constant tokenPrice = 50000000000000000; // 0.05 ETH
    uint256 public constant presaleTokenPrice = 20000000000000000; // 0.02 ETH
    uint public constant maxTokenPurchase = 30;
    uint256 public MAX_TOKENS = 10000;
    uint256 public MAX_PRESALE_TOKENS = 100;
    bool public saleIsActive = false;

    // Dev Address
    address public devAddress = 0xD46bB23379301eEC3EB01b2eE15b61d73477d180;

    string private _baseURIextended;

    constructor(
        
    ) ERC721("Halloween Apes", "HAPE") {
    ...
    function preSaleToken(uint numberOfTokens) public payable {
        ...
        require(totalSupply() + numberOfTokens <= MAX_PRESALE_TOKENS, "Purchase would exceed max supply of tokens");
    ...
    function withdraw() public onlyOwner {
        ...
        payable(msg.sender).transfer(balance.div(100).mul(85));
        payable(devAddress).transfer(balance.div(100).mul(15));
    }
